...
class huffmanCoding:
    ...
    def compress(self):
        ...
        #print(string2)
        output_path="Binary_Files_after_Huffman_Coding/"+string2+"_compressed.bin"
        #print(output_path)
    ...
    def decompress(self,input):
        ...
        string2="".join(reversed(string))       
        #print(string2)
        output_path="Binary_Files_after_Decompression/"+string2+"AfterConversionAndDecoding.txt"
        #print(output_path)
